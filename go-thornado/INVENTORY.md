# Go Thornado Fork Inventory

Agent: Agent 1, Go Thornado Go fork workstream.
...
- Current state of this directory: upstream source copied into `go-thornado/`
...
- `app/`, `cmd/thornado/`, `app/params/`: keep Cosmos SDK app wiring, CLI/node
...
1. Copy/fork upstream source into `go-thornado/` and record the same upstream
...
- Need a stable Thornado withdrawal message contract before production Shielder
...
- These needs are noted here only; FROST signer plumbing remains future work.
