...
func (x *fastReflection_MsgKeygenVault) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.VaultPubKeyFrost) > 0 {
			i -= len(x.VaultPubKeyFrost)
			copy(dAtA[i:], x.VaultPubKeyFrost)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.VaultPubKeyFrost)))
			i--
			dAtA[i] = 0x7a
		}
		if len(x.KeysharesBackupFrost) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 15:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field VaultPubKeyFrost", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.VaultPubKeyFrost = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 16:
				if wireType != 0 {
...
type MsgKeygenVault struct {
	...
	VaultPubKeyEddsa     string     `protobuf:"bytes,12,opt,name=vault_pub_key_eddsa,json=vaultPubKeyEddsa,proto3" json:"vault_pub_key_eddsa,omitempty"`
	...
	VaultPubKeyFrost     string     `protobuf:"bytes,15,opt,name=vault_pub_key_frost,json=vaultPubKeyFrost,proto3" json:"vault_pub_key_frost,omitempty"`
...
var file_types_msg_keygen_vault_proto_rawDesc = []byte{
	...
	0x01, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x42, 0x13, 0x4d, 0x73,
	0x67, 0x4b, 0x65, 0x79, 0x67, 0x65, 0x6e, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x50, 0x72, 0x6f, 0x74,
