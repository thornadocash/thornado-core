...
const (
	...
	Query_VaultSigners_FullMethodName         = "/types.Query/VaultSigners"
...
func (c *queryClient) VaultSigners(ctx context.Context, in *QueryVaultSignersRequest, opts ...grpc.CallOption) (*QueryVaultSignersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_VaultSigners_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Gas(ctx context.Context, in *QueryGasRequest, opts ...grpc.CallOption) (*QueryGasResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Gas_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) VaultSigners(context.Context, *QueryVaultSignersRequest) (*QueryVaultSignersResponse, error) {
...
func _Query_VaultSigners_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_VaultSigners_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
