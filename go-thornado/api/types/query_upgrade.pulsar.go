...
var (
	...
	fd_QueryUpgradeProposalResponse_nodes_to_quorum  protoreflect.FieldDescriptor
...
func init() {
	...
	fd_QueryUpgradeProposalResponse_nodes_to_quorum = md_QueryUpgradeProposalResponse.Fields().ByName("nodes_to_quorum")
...
func (x *fastReflection_QueryUpgradeProposalResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.NodesToQuorum != int64(0) {
		value := protoreflect.ValueOfInt64(x.NodesToQuorum)
		if !f(fd_QueryUpgradeProposalResponse_nodes_to_quorum, value) {
			return
		}
	}
...
func (x *fastReflection_QueryUpgradeProposalResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "types.QueryUpgradeProposalResponse.nodes_to_quorum":
		return x.NodesToQuorum != int64(0)
...
func (x *fastReflection_QueryUpgradeProposalResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "types.QueryUpgradeProposalResponse.nodes_to_quorum":
		panic(fmt.Errorf("field nodes_to_quorum of message types.QueryUpgradeProposalResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: types.QueryUpgradeProposalResponse"))
		}
...
func (x *fastReflection_QueryUpgradeProposalResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.NodesToQuorum != 0 {
			n += 1 + runtime.Sov(uint64(x.NodesToQuorum))
		}
		if len(x.Approvers) > 0 {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.NodesToQuorum != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.NodesToQuorum))
			i--
			dAtA[i] = 0x30
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 6:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field NodesToQuorum", wireType)
				}
				x.NodesToQuorum = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.NodesToQuorum |= int64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
type QueryUpgradeProposalResponse struct {
	...
	// whether the upgrade has been approved by the active nodes
	Approved bool `protobuf:"varint,4,opt,name=approved,proto3" json:"approved,omitempty"`
	// the percentage of active nodes that have approved the upgrade
	...
	// the amount of additional active nodes required to reach quorum for the
	// upgrade
	NodesToQuorum int64 `protobuf:"varint,6,opt,name=nodes_to_quorum,json=nodesToQuorum,proto3" json:"nodes_to_quorum,omitempty"`
...
func (x *QueryUpgradeProposalResponse) GetNodesToQuorum() int64 {
	if x != nil {
		return x.NodesToQuorum
	}
	return 0
}
...
var file_types_query_upgrade_proto_rawDesc = []byte{
	...
	0x67, 0x68, 0x74, 0x22, 0xfe, 0x02, 0x0a, 0x1c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x55, 0x70, 0x67,
	...
	,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x71, 0x0a, 0x1d,
	...
	0x11, 0x75, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x5f, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61,
	0x6c, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73,
	0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x50, 0x72, 0x6f,
	0x70, 0x6f, 0x73, 0x61, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x10, 0x75,
	0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x73, 0x22,
	0x46, 0x0a, 0x18, 0x51, 0x75, 0x65, 0x72, 0x79, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x56,
	...
	0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x60, 0x0a, 0x0b, 0x55, 0x70, 0x67, 0x72, 0x61,
	0x64, 0x65, 0x56, 0x6f, 0x74, 0x65, 0x12, 0x33, 0x0a, 0x0c, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x61,
	...
	,
