...
//
// Create service with RPC method to send tx in quorum to thornado
type LocalhostBifrostClient interface {
	...
	SubscribeToEvents(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[EventNotification], error)
}
...
func (c *localhostBifrostClient) SendQuorumTx(ctx context.Context, in *common.QuorumTx, opts ...grpc.CallOption) (*SendQuorumTxResult, error) {
	...
	err := c.cc.Invoke(ctx, LocalhostBifrost_SendQuorumTx_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localhostBifrostClient) SendQuorumNetworkFee(ctx context.Context, in *common.QuorumNetworkFee, opts ...grpc.CallOption) (*SendQuorumNetworkFeeResult, error) {
	...
	err := c.cc.Invoke(ctx, LocalhostBifrost_SendQuorumNetworkFee_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localhostBifrostClient) SendQuorumSolvency(ctx context.Context, in *common.QuorumSolvency, opts ...grpc.CallOption) (*SendQuorumSolvencyResult, error) {
	...
	err := c.cc.Invoke(ctx, LocalhostBifrost_SendQuorumSolvency_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localhostBifrostClient) SendQuorumErrataTx(ctx context.Context, in *common.QuorumErrataTx, opts ...grpc.CallOption) (*SendQuorumErrataTxResult, error) {
	...
	err := c.cc.Invoke(ctx, LocalhostBifrost_SendQuorumErrataTx_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localhostBifrostClient) SendQuorumPriceFeedBatch(ctx context.Context, in *common.QuorumPriceFeedBatch, opts ...grpc.CallOption) (*SendQuorumPriceFeedBatchResult, error) {
	...
	err := c.cc.Invoke(ctx, LocalhostBifrost_SendQuorumPriceFeedBatch_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localhostBifrostClient) SubscribeToEvents(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[EventNotification], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LocalhostBifrost_ServiceDesc.Streams[0], LocalhostBifrost_SubscribeToEvents_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeRequest, EventNotification]{ClientStream: stream}
...
type LocalhostBifrost_SubscribeToEventsClient = grpc.ServerStreamingClient[EventNotification]
...
type LocalhostBifrostServer interface {
	...
	// Server streaming for notifications
	SubscribeToEvents(*SubscribeRequest, grpc.ServerStreamingServer[EventNotification]) error
	mustEmbedUnimplementedLocalhostBifrostServer()
}

// UnimplementedLocalhostBifrostServer must be embedded to have
...
func (UnimplementedLocalhostBifrostServer) SendQuorumTx(context.Context, *common.QuorumTx) (*SendQuorumTxResult, error) {
	return nil, status.Error(codes.Unimplemented, "method SendQuorumTx not implemented")
}
func (UnimplementedLocalhostBifrostServer) SendQuorumNetworkFee(context.Context, *common.QuorumNetworkFee) (*SendQuorumNetworkFeeResult, error) {
	return nil, status.Error(codes.Unimplemented, "method SendQuorumNetworkFee not implemented")
}
func (UnimplementedLocalhostBifrostServer) SendQuorumSolvency(context.Context, *common.QuorumSolvency) (*SendQuorumSolvencyResult, error) {
	return nil, status.Error(codes.Unimplemented, "method SendQuorumSolvency not implemented")
}
func (UnimplementedLocalhostBifrostServer) SendQuorumErrataTx(context.Context, *common.QuorumErrataTx) (*SendQuorumErrataTxResult, error) {
	return nil, status.Error(codes.Unimplemented, "method SendQuorumErrataTx not implemented")
}
func (UnimplementedLocalhostBifrostServer) SendQuorumPriceFeedBatch(context.Context, *common.QuorumPriceFeedBatch) (*SendQuorumPriceFeedBatchResult, error) {
	return nil, status.Error(codes.Unimplemented, "method SendQuorumPriceFeedBatch not implemented")
}
func (UnimplementedLocalhostBifrostServer) SubscribeToEvents(*SubscribeRequest, grpc.ServerStreamingServer[EventNotification]) error {
...
func (UnimplementedLocalhostBifrostServer) testEmbeddedByValue()                          {}
...
func RegisterLocalhostBifrostServer(s grpc.ServiceRegistrar, srv LocalhostBifrostServer) {
	// If the following call panics, it indicates UnimplementedLocalhostBifrostServer was
...
func _LocalhostBifrost_SubscribeToEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(LocalhostBifrostServer).SubscribeToEvents(m, &grpc.GenericServerStream[SubscribeRequest, EventNotification]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type LocalhostBifrost_SubscribeToEventsServer = grpc.ServerStreamingServer[EventNotification]
