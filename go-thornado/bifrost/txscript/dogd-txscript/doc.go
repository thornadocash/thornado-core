...
/*
Package txscript implements the dogecoin transaction script language.

A complete description of the script language used by dogecoin can be found at
https://en.dogecoin.it/wiki/Script.  The following only serves as a quick
...
dogecoin transaction scripts.

# Script Overview

Dogecoin transaction scripts are written in a stack-base, FORTH-like language.

The dogecoin script language consists of a number of opcodes which fall into
...
The vast majority of Dogecoin scripts at the time of this writing are of several
...
what conditions must be met in order to spend dogecoins.
