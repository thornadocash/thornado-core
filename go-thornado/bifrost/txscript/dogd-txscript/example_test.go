// Copyright (c) 2014-2016 The eager7 developers
...
// This example demonstrates creating a script which pays to a dogecoin address.
...
func ExamplePayToAddrScript() {
	...
	// PayToAddrScript.
	addressStr := "D6pv4fSFVjw8ETZ1RZL4AxQruYbLBeVe4P"
...
func ExampleExtractPkScriptAddrs() {
	...
	// Addresses: [D6pv4fSFVjw8ETZ1RZL4AxQruYbLBeVe4P]
...
func ExampleSignTxOutput() {
	...
	// contains a single output that pays to address in the amount of 1 DOGE.
