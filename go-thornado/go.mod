module github.com/thornadocash/go-thornado
...
replace (
	...
	github.com/thornadocash/go-thornado => ./
	// redirect any non-v3 thornado imports to local code
	github.com/thornadocash/go-thornado/x/thornado => ./x/thornado
