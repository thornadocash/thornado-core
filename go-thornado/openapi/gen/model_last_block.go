...
func NewLastBlock(chain string, lastObservedIn int64, lastSignedOut int64, thornado int64) *LastBlock {
	this := LastBlock{}
	this.Chain = chain
	this.LastObservedIn = lastObservedIn
	this.LastSignedOut = lastSignedOut
	this.Thornado = thornado
	return &this
}
...
// GetThornado returns the Thornado field value
func (o *LastBlock) GetThornado() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// GetThornadoOk returns a tuple with the Thornado field value
// and a boolean to check if the value has been set.
func (o *LastBlock) GetThornadoOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Thornado, true
}

// SetThornado sets field value
func (o *LastBlock) SetThornado(v int64) {
	o.Thornado = v
}
...
func (o LastBlock) MarshalJSON_deprecated() ([]byte, error) {
	...
	if true {
		toSerialize["thornado"] = o.Thornado
	}
