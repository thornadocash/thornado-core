...
func (mv *NetworkMgr) fetchPOLPools(ctx cosmos.Context, mgr Manager) ([]common.Asset, []int64) {
	return nil, nil
}
...
func (vm *NetworkMgr) canRagnarokGasPool(ctx cosmos.Context, c common.Chain, allPools []common.Asset) bool {
	return false
}
...
func (vm *NetworkMgr) ragnarokPool(ctx cosmos.Context, mgr Manager, p common.Asset) error {
	return nil
}
