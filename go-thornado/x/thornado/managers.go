...
import (
	...
	kv1 "github.com/thornadocash/go-thornado/x/thornado/keeper/v1"
...
// NodeManager define the method to manage nodes
...
func (mgr *Mgrs) recreateManagers(ctx cosmos.Context, v semver.Version) error {
	...
	mgr.nodeMgr, err = GetNodeManager(v, mgr.K, mgr.networkMgr, mgr.txOutStore, mgr.eventMgr)
	if err != nil {
		return fmt.Errorf("fail to get node manager: %w", err)
	}
...
// NodeMgr return an implementation of NodeManager
func (mgr *Mgrs) NodeMgr() NodeManager { return mgr.nodeMgr }
...
// GetNodeManager create a new instance of Node Manager
func GetNodeManager(_ semver.Version, keeper keeper.Keeper, networkMgr NetworkManager, txOutStore TxOutStore, eventMgr EventManager) (NodeManager, error) {
	return newNodeMgr(keeper, networkMgr, txOutStore, eventMgr), nil
}
