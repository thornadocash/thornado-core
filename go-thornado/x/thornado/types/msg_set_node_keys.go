...
func NewMsgSetNodeKeys(nodePubKeySet common.PubKeySet, nodeConsPubKey string, signer cosmos.AccAddress) *MsgSetNodeKeys {
...
func (m *MsgSetNodeKeys) ValidateBasic() error {
	...
	if _, err := cosmos.GetPubKeyFromBech32(cosmos.Bech32PubKeyTypeConsPub, m.NodeConsPubKey); err != nil {
