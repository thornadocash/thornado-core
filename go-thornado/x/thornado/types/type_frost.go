...
// NewFrostVoter create a new instance of FrostVoter
func NewFrostVoter(id string, pks []string, pool, vaultPubKeyEddsa common.PubKey) FrostVoter {
	return FrostVoter{
		ID:               id,
		PubKeys:          pks,
		VaultPubKey:      pool,
...
func (m *FrostVoter) GetChains() common.Chains {
...
func (m *FrostVoter) GetPubKeys() common.PubKeys {
...
func (m *FrostVoter) GetSigners() []cosmos.AccAddress {
...
func (m *FrostVoter) HasSigned(signer cosmos.AccAddress) bool {
...
func (m *FrostVoter) Sign(signer cosmos.AccAddress, chains []string, secp256k1Signature string) bool {
...
func (m *FrostVoter) ConsensusChains() common.Chains {
...
func (m *FrostVoter) HasCompleteConsensus() bool {
...
func (m *FrostVoter) ConsensusCheckSignature() (string, bool) {
...
func (m *FrostVoter) HasConsensus() bool {
	return HasSuperMajority(len(m.Signers), len(m.PubKeys))
}

// IsEmpty check whether FrostVoter represent empty info
func (m *FrostVoter) IsEmpty() bool {
	return len(m.ID) == 0 || len(m.VaultPubKey) == 0 || len(m.PubKeys) == 0
}

// String implement fmt.Stringer
func (m *FrostVoter) String() string {
	return m.ID
}
