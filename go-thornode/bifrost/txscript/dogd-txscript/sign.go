// Copyright (c) 2013-2015 The eager7 developers
...
// WitnessSignature creates an input witness stack for tx to spend DOGE sent
...
// SignatureScript creates an input signature script for tx to spend DOGE sent
...
func signMultiSig(tx *wire.MsgTx, idx int, subScript []byte, hashType SigHashType,
	addresses []dogutil.Address, nRequired int, kdb KeyDB,
) ([]byte, bool) {
