// Copyright (c) 2013-2015 The ltcsuite developers
...
// WitnessSignature creates an input witness stack for tx to spend LTC sent
...
// SignatureScript creates an input signature script for tx to spend LTC sent
...
func signMultiSig(tx *wire.MsgTx, idx int, subScript []byte, hashType SigHashType,
	addresses []ltcutil.Address, nRequired int, kdb KeyDB,
) ([]byte, bool) {
