...
type ApiSecuredAssetsRequest struct {
	ctx context.Context
	ApiService *SecuredAssetsApiService
	height *int64
}
...
func (r ApiSecuredAssetsRequest) Execute() ([]SecuredAssetResponse, *http.Response, error) {
	return r.ApiService.SecuredAssetsExecute(r)
}
...
Returns the total size and ratio of all secured asset
 ...
 @return ApiSecuredAssetsRequest
*/
...
func (a *SecuredAssetsApiService) SecuredAssetsExecute(r ApiSecuredAssetsRequest) ([]SecuredAssetResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecuredAssetsApiService.SecuredAssets")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/thorchain/securedassets"
