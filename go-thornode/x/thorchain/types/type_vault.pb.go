...
type Vault struct {
	...
	PubKeyEddsa           gitlab_com_thorchain_thornode_v3_common.PubKey `protobuf:"bytes,24,opt,name=pub_key_eddsa,json=pubKeyEddsa,proto3,casttype=gitlab.com/thorchain/thornode/v3/common.PubKey" json:"pub_key_eddsa,omitempty"`
}
